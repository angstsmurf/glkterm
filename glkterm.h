...
extern char*pref_savegame;
extern char*pref_transcript;
extern int pref_allow_prompt;
extern FILE*pref_script;
extern int pref_zcolormode;

/* Filename mapping */
#define filename_mapping gli_filename_mapping
#define num_filename_mapping gli_num_filename_mapping
typedef struct {
  char*glkname;
  char*native;
  char writable;
...
/* User gestalt */
#define user_gestalt gli_user_gestalt
#define num_user_gestalt gli_num_user_gestalt
typedef struct {
  glui32 id;
  glui32 val;
} User_Gestalt;
extern User_Gestalt*user_gestalt;
extern int num_user_gestalt;
