...
#ifdef OPT_USE_MKSTEMP
    if(pref_readonly && !pref_temporary_filename) return NULL;
#else
    ...
    glui32 rock)
{
    ...
    if(!pref_allow_prompt) {
        gli_strict_warning("fileref_create_by_prompt: disabled by user preferences.");
        return NULL;
    }
