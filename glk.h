...
extern void glk_set_color(glui32 val);
extern void glk_set_color_stream(strid_t str, glui32 val);
extern void glk_set_zstyle(glui32 val);
extern void glk_set_zstyle_stream(strid_t str, glui32 val);
